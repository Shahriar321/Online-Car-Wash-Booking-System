...
<body>
                    ...
                    <li><a href="index.php">Home</a></li>
						...
						<?php
								...
								if($_SESSION["user"]==null){
									header("Location: http://localhost/Online Car Wash/index.php");
								} else{
            ...
            <div class="content-rg">
                <div class="wj-rg3">
                    <form method="post" id="myform" action="phpsrc/bookingManagement.php">
                        ...
                        <div class="yysm">
                            <span style="margin-top: 18px; color: Blue;" >
                              Instructions
                            </span>
                            <p>
                                Select one out of a variety of options namely
                                </br>(i) wash outside only(The touchless wash equipment is designed to apply a special car wash chemical product, followed by high-pressure, low-volume water spray, to achieve the highest quality wash finish.) <b>$200</b>
                                </br>(ii) wash inside and outside(Designed specifically for automotive dealerships, fleet and rental car businesses where a simple, superior, high-volume wash is required.)<b>$250</b>,
                                </br>(iii) deluxe wash(Our broad range of rollover car wash machines are available in various configurations from a simple low volume, 3 brush commercial machine through to a fully configures, high speed, multi-brush unit.) <b>$300</b>
                                </br>(iv)Express mini tunnels(Express mini tunnels can be configured for your standard wash bay length or a conversion upgrade of an existing rollover to a conveyor wash system.) <b>$400</b>
                        ...
                        <div class="ky-style">
                            <div class="teacher5-top">
                                <select class="inputNum form-control" name='serviceOption' id="serviceOption">
                                    <option value='1' selected>Wash outside only($200)</option>
                                    <option value='2'>Wash inside and outside($250)</option>
                                    <option value='3'>Deluxe wash($300) </option>
                                    <option value="4">Express mini tunnels($400)</option>
                                </select>
                            </div>
                        </div>
    ...
    $('.timeTableDate').ready(function () {
      ...
      for (var i = 0; i < tdsCollection2.length; i++) {
        ...
        // changeAvailable("2023-10-12 12:00");
        <?php
